...
extension GetCharacterEntityCollection on Isar {
  IsarCollection<CharacterEntity> get characters => this.collection();
}
...
const CharacterEntitySchema = CollectionSchema(
  ...
  properties: {
    ...
    r'gender': PropertySchema(
      ...
      name: r'gender',
      type: IsarType.byte,
      enumMap: _CharacterEntitygenderEnumValueMap,
    ),
  ...
  links: {},
  embeddedSchemas: {
    r'CharacterOriginEntity': CharacterOriginEntitySchema,
    r'CharacterLocationEntity': CharacterLocationEntitySchema
  },
...
int _characterEntityEstimateSize(
  ...
  bytesCount += 3 +
      CharacterLocationEntitySchema.estimateSize(
          object.location, allOffsets[CharacterLocationEntity]!, allOffsets);
  bytesCount += 3 + object.name.length * 3;
  bytesCount += 3 +
      CharacterOriginEntitySchema.estimateSize(
          object.origin, allOffsets[CharacterOriginEntity]!, allOffsets);
...
const _CharacterEntitygenderEnumValueMap = {
  'female': 0,
  'male': 1,
  'genderless': 2,
  'unknown': 3,
};
const _CharacterEntitygenderValueEnumMap = {
  0: CharacterGender.female,
  1: CharacterGender.male,
  2: CharacterGender.genderless,
  3: CharacterGender.unknown,
};
const _CharacterEntitystatusEnumValueMap = {
  'alive': 0,
  'dead': 1,
  'unknown': 2,
};
const _CharacterEntitystatusValueEnumMap = {
...
extension CharacterEntityQueryObject
    on QueryBuilder<CharacterEntity, CharacterEntity, QFilterCondition> {
  QueryBuilder<CharacterEntity, CharacterEntity, QAfterFilterCondition>
      location(FilterQuery<CharacterLocationEntity> q) {
    return QueryBuilder.apply(this, (query) {
      return query.object(q, r'location');
    });
  }

  QueryBuilder<CharacterEntity, CharacterEntity, QAfterFilterCondition> origin(
      FilterQuery<CharacterOriginEntity> q) {
    return QueryBuilder.apply(this, (query) {
...
extension CharacterEntityQueryProperty
  ...
  QueryBuilder<CharacterEntity, CharacterGender, QQueryOperations>
      genderProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CharacterEntity, CharacterLocationEntity, QQueryOperations>
      locationProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CharacterEntity, CharacterOriginEntity, QQueryOperations>
      originProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CharacterEntity, CharacterStatus, QQueryOperations>
      statusProperty() {
    return QueryBuilder.apply(this, (query) {
...
const CharacterOriginEntitySchema = Schema(
  name: r'CharacterOriginEntity',
  id: 6606811293895364143,
  properties: {
    r'name': PropertySchema(
      id: 0,
      name: r'name',
  ...
  estimateSize: _characterOriginEntityEstimateSize,
  serialize: _characterOriginEntitySerialize,
  deserialize: _characterOriginEntityDeserialize,
  deserializeProp: _characterOriginEntityDeserializeProp,
);

int _characterOriginEntityEstimateSize(
  CharacterOriginEntity object,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  var bytesCount = offsets.last;
...
void _characterOriginEntitySerialize(
  CharacterOriginEntity object,
  IsarWriter writer,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
...
CharacterOriginEntity _characterOriginEntityDeserialize(
  Id id,
  IsarReader reader,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  final object = CharacterOriginEntity(
...
P _characterOriginEntityDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
...
extension CharacterOriginEntityQueryFilter on QueryBuilder<
    CharacterOriginEntity, CharacterOriginEntity, QFilterCondition> {
  QueryBuilder<CharacterOriginEntity, CharacterOriginEntity,
...
extension CharacterOriginEntityQueryObject on QueryBuilder<
    CharacterOriginEntity, CharacterOriginEntity, QFilterCondition> {}

// coverage:ignore-file
// ignore_for_file: duplicate_ignore, non_constant_identifier_names, constant_identifier_names, invalid_use_of_protected_member, unnecessary_cast, prefer_const_constructors, lines_longer_than_80_chars, require_trailing_commas, inference_failure_on_function_invocation, unnecessary_parenthesis, unnecessary_raw_strings, unnecessary_null_checks, join_return_with_assignment, prefer_final_locals, avoid_js_rounded_ints, avoid_positional_boolean_parameters, always_specify_types

const CharacterLocationEntitySchema = Schema(
  name: r'CharacterLocationEntity',
  id: -4314203077462214098,
  properties: {
    r'name': PropertySchema(
      id: 0,
      name: r'name',
  ...
  estimateSize: _characterLocationEntityEstimateSize,
  serialize: _characterLocationEntitySerialize,
  deserialize: _characterLocationEntityDeserialize,
  deserializeProp: _characterLocationEntityDeserializeProp,
);

int _characterLocationEntityEstimateSize(
  CharacterLocationEntity object,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  var bytesCount = offsets.last;
...
void _characterLocationEntitySerialize(
  CharacterLocationEntity object,
  IsarWriter writer,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
...
CharacterLocationEntity _characterLocationEntityDeserialize(
  Id id,
  IsarReader reader,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  final object = CharacterLocationEntity(
    name: reader.readStringOrNull(offsets[0]) ?? '',
    url: reader.readStringOrNull(offsets[1]) ?? '',
  );
  return object;
...
P _characterLocationEntityDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
...
extension CharacterLocationEntityQueryFilter on QueryBuilder<
    CharacterLocationEntity, CharacterLocationEntity, QFilterCondition> {
  QueryBuilder<CharacterLocationEntity, CharacterLocationEntity,
      QAfterFilterCondition> nameEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
...
extension CharacterLocationEntityQueryObject on QueryBuilder<
    CharacterLocationEntity, CharacterLocationEntity, QFilterCondition> {}
