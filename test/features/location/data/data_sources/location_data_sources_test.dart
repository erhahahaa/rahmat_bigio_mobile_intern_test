...
void main() {
  ...
  group('Get Locations', () {
    ...
    test('SHOULD return a ServerFailure WHEN the call is unsuccessful',
      ...
      when(dioClient.getRequest(
        ...
        (_) async => Left<Failure, List<LocationModel>>(ServerFailure()),
      );
  ...
  group('Get Location', () {
    test('SHOULD return a LocationModel WHEN the call is successful', () async {
      ...
      // Act
      final result = await dataSource.getLocation(ByIdParam(id: 1));
    ...
    test('SHOULD return a ServerFailure WHEN the call is unsuccessful',
      ...
      when(dioClient.getRequest(
        ...
        (_) async => Left<Failure, LocationModel>(ServerFailure()),
      );
